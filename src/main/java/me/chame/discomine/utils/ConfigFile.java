...
public class ConfigFile {
    ...
    public String getProperty(String property) {
        Properties properties = propertiesStorage.get("discomine");
        return properties.getProperty(property);
    }

    private static Properties loadProperties(String name) {
        final String pathProperties = "assets/discomine/" + name + ".properties";
        File propertiesFile = new File("config/" + name + ".properties");
        ...
        try {
            ...
            directory.mkdir();
            defProperties.load(DiscoMine.class.getResourceAsStream("/" + pathProperties));
